...
export default function Details() {
    ...
    const message = `Olá ${incident.name}! Gostaria de ajudar no caso ${incident.title} com o a valor de ${Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(incident.value)}`;
